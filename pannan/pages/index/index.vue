<template>
	<view>
		<view class="type_">
			<view class="box" @click="changedis(0)"><view class="msg" :class="{ boddr: nodis == 0 }">待取件</view></view>
			<view class="box" @click="changedis(1)"><view class="msg" :class="{ boddr: nodis == 1 }">待配送</view></view>
			<view class="box" @click="changedis(2)"><view class="msg" :class="{ boddr: nodis == 2 }">已完成</view></view>
		</view>
		<view class="dd_">
			<view v-show="nodis == 0">
				<view class="box_" v-for="(dq, key) in dqj" @click="linkxq(dq.id)" :key="key">
					<view class="main_">
						<view class="t_" v-if="dq.tz == 'quxiao'"><view class="time" style="color:red;">订单已取消</view></view>
						<view class="t_">
