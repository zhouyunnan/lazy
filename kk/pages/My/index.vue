<template>
  <view class="my_">
    <view :class="[userinfo ? 'my_header_sqh' : 'my_header']">
      <view class="my_header_tx" v-if="!userinfo">
    ...
    <view class="my_content">
      <!-- <view class="my_content_nav" @click="linkschool()">
      ...
      <view class="my_content_nav" @click="linkweb()">
...
export default {
  ...
  methods: {
    linkweb() {
      uni.navigateTo({
        url: "/pages/Web/Web?url=" + encodeURIComponent(
