	...
	<view :style="{zIndex: zIndex}" class="container">
		<block v-for="message in messageQueue" :key="message.id">
			<view :class="[message.animation, backgroundClass(message)]" class="message">
				<text v-if="message.type === 'info'" class="bm-icon "></text>
				<text v-if="message.type === 'success'" class="bm-icon "></text>
				<text v-if="message.type === 'warn'" class="bm-icon "></text>
				<text v-if="message.type === 'error'" class="bm-icon "></text>
